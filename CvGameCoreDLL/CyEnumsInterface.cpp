...
void CyEnumsPythonInterface()
{
	...
	python::enum_<ChessPieceTypes>("ChessPieceTypes")
		.value("NO_PIECE_TYPE", NO_CHESS_PIECE)
		.value("CHESS_PIECE_PAWN", CHESS_PIECE_PAWN)
		.value("CHESS_PIECE_KNIGHT", CHESS_PIECE_KNIGHT)
		.value("CHESS_PIECE_BISHOP", CHESS_PIECE_BISHOP)
		.value("CHESS_PIECE_ROOK", CHESS_PIECE_ROOK)
		.value("CHESS_PIECE_QUEEN", CHESS_PIECE_QUEEN)
		.value("CHESS_PIECE_KING", CHESS_PIECE_KING)
		;
}
